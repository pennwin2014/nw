...
create   table nwproclog_201401 (
    ...
    wndtime   int unsigned default 0                        --  窗口活动时间 20130917添加
);

---- 文件操作日志 （每天一个表）
drop     table if exists nwfilelog_201312;
create   table nwfilelog_201312 (
    sid       bigint  auto_increment  primary key,    -- 序列号
    compid    int unsigned,                                -- 计算机ID
    userid    int unsigned default 0,            	   --  用户ID	
    mac       char(20)  default '',                       --  MAC地址
...
---- 外设操作日志 （每天一个表）
drop     table if exists nwremovelog_201312;
create   table nwremovelog_201312 (
    sid       bigint auto_increment  primary key,    -- 序列号
    compid    int unsigned,                                -- 计算机ID
    userid    int unsigned default 0,            	   --  用户ID	
    mac       char(20)  default '',                       --  MAC地址
...
drop     table if exists ncimclient_201312;
create   table ncimclient_201312 (
    ...
    mto       char(48),
    mesg      varchar(255),         --  内容 
    sesid     int unsigned   default 0,      --   会?癐D  
...
-- 屏幕JPG日志  （每天一个表）
drop table if exists ncscreenlog_201312;
create table ncscreenlog_201312 (
    sid  	    bigint auto_increment  primary key,    -- 序列号
     compid    int unsigned,                                -- 计算机ID
    userid    int unsigned default 0,            	   --  用户ID
	  groupid   int unsigned default 0,                  -- 部门Id
...
-- 网页操作日志 （每天一个表）
drop     table if exists nwweblog_201312;
create   table nwweblog_201312 (
    sid       bigint auto_increment  primary key,    -- 序列号
     compid    int unsigned,                                -- 计算机ID
    userid    int unsigned default 0,            	   --  用户ID	
    mac       char(20)  default '',                       --  MAC地址
...
create   table nwprocyobj (
    ...
    stime         int unsigned,                                 -- 起始时间 格式080000  表示8时0分0秒
    etime         int unsigned,                                 -- 终止时间 格式235959  表示23时59分59秒
