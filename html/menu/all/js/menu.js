...
function write()
{
	...
	if(x==0){
		stringx += "<tr><td  width=100% height=150px ><iframe width=100% height=150 frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
