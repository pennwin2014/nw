...
function write()
{
	...
	if(x==1){
		stringx += "<tr><td  width=100% height=200px ><iframe width=100% height=200 frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
...
pmenu8=new Menu('计费管理','','self');
pmenu8.addItem(new MenuItem('察看','goto("new.htm")','sbpm_right',false,'文件1'));

pmenu9=new Menu('系统(S)','','self');
pmenu9.addItem(new MenuItem('察看','goto("new.htm")','sbpm_right',false,'文件1'));

pmenu10=new Menu('帮助(H)','','self');
pmenu10.addItem(new MenuItem('察看','goto("new.htm")','sbpm_right',false,'文件1'));
