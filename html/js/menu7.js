...
function write()
{
   ...
   var temp_h;
	...
	if(x==0){
		stringx += "<tr><td  width=100% height=179px ><iframe width=100% height="+temp_h+" frameborder=0 scrolling=no src='/7layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
	
	 temp_h=parseInt(150)+3;
	if(x==1){
		stringx += "<tr><td  width=100% height=150px ><iframe width=100% height="+temp_h+" frameborder=0 scrolling=no src='/7layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
	
	 temp_h=parseInt(400)+3;
	if(x==2){
		stringx += "<tr><td  width=100% height=400px ><iframe width=100% height="+temp_h+" frameborder=0 scrolling=no src='/7layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
	
	 temp_h=parseInt(300)+3;
	if(x==3){
		stringx += "<tr><td  width=100% height=300px ><iframe width=100% height="+temp_h+" frameborder=0 scrolling=no src='/7layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
	
	 temp_h=parseInt(30)+3;
	if(x==4){
		stringx += "<tr><td  width=100% height=30px ><iframe width=100% height="+temp_h+" frameborder=0 scrolling=no src='/7layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
	
	 temp_h=parseInt(260)+3;
	if(x==5){
		stringx += "<tr><td  width=100% height=260px ><iframe width=100% height="+temp_h+" frameborder=0 scrolling=no src='/7layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
	
	 temp_h=parseInt(100)+3;
	if(x==6){
		stringx += "<tr><td  width=100% height=100px ><iframe width=100% height="+temp_h+" frameborder=0 scrolling=no src='/7layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
	
	 temp_h=parseInt(180)+3;
	if(x==7){
		stringx += "<tr><td  width=100% height=180px ><iframe width=100% height="+temp_h+" frameborder=0 scrolling=no src='/7layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
	
	 temp_h=parseInt(25)+3;
	if(x==8){
		stringx += "<tr><td  width=100% height=25px ><iframe width=100% height="+temp_h+" frameborder=0 scrolling=no src='/7layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
