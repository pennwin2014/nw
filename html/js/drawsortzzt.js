...
_p.drawLineY = function(oContainer){
 ...
 for(var i=0; i<=dcs; i++){
  ...
  newShape= document.createElement("<v:shape style='position:absolute;left:"+ eval(x-280) +";top:"+ eval(py-50) +";WIDTH:300px;HEIGHT:150px;z-index:8' coordsize='21600,21600' fillcolor='white'></v:shape>");
...
// else 
 ...
 for(var i=1; i<=showPoint; i++){
  ...
  newShape= document.createElement("<v:shape style='position:absolute;left:"+ eval((px-fColWidth/2)-250) +";top:"+ eval(y+this.AxisX.Spacing) +";WIDTH:430px;HEIGHT:400px;z-index:8' coordsize='21600,21600' fillcolor='white'></v:shape>");

  newText = document.createElement("<v:textbox inset='0pt,0pt,0pt,0pt' style='font-family:@宋体;font-size:12px;color:"+ this.AxisY.Color +"'></v:textbox>");
