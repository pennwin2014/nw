...
function write()
{
   ...
   var temp_h;
	 ...
	 temp_h=parseInt(179)+3;
	if(x==0){
		stringx += "<tr><td  width=100% height=179px ><iframe width=100% height="+temp_h+" frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
	
	 temp_h=parseInt(150)+3;
	if(x==1){
		stringx += "<tr><td  width=100% height=150px ><iframe width=100% height="+temp_h+" frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
	
	 temp_h=parseInt(400)+3;
	if(x==2){
		stringx += "<tr><td  width=100% height=400px ><iframe width=100% height="+temp_h+" frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
	...
	if(x==3){
	 ...
	 temp_h=parseInt(250)+3;
	if(x==4){
		stringx += "<tr><td  width=100% height=250px ><iframe width=100% height="+temp_h+" frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
	
	 temp_h=parseInt(329)+3;
	if(x==5){
		stringx += "<tr><td  width=100% height=329px ><iframe width=100% height="+temp_h+" frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
	
	 temp_h=parseInt(204)+3;
	if(x==6){
		stringx += "<tr><td  width=100% height=204px ><iframe width=100% height="+temp_h+" frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
	
	 temp_h=parseInt(308)+3;
	if(x==7){
		stringx += "<tr><td  width=100% height=308px ><iframe width=100% height="+temp_h+" frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
	
	 temp_h=parseInt(304)+3;
	if(x==8){
		stringx += "<tr><td  width=100% height=304px ><iframe width=100% height="+temp_h+" frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
	
	 temp_h=parseInt(25)+3;
	if(x==9){
		stringx += "<tr><td  width=100% height=25px ><iframe width=100% height="+temp_h+" frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n"; 
	}
